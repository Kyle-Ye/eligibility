...
int64_t os_eligibility_force_domain_answer(EligibilityDomainType domain, EligibilityAnswer answer, xpc_object_t _Nullable context);
int64_t os_eligibility_get_internal_state(xpc_object_t _Nonnull * _Nonnull internal_state_ptr);
...
int64_t os_eligibility_get_state_dump(xpc_object_t _Nonnull * _Nonnull state_dump_dictionary_ptr);
